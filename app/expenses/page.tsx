...
import ExpenseEntryLink from "../components/ExpenseEntryLink";
...
export default async function ExpensesPage() {
  ...
  return <><SupervisorExpenseStyles /><SupervisorExpenseDashboard user={user} /><ExpenseEntryLink /><SupervisorReimbursementHistory /></>;
}
