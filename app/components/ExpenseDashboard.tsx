...
type AppData = { customers: Customer[]; historyCustomers: Customer[]; persons: Person[]; vendors: Vendor[]; orders: Order[]; historyOrders: Order[]; orderVendors: OrderVendor[]; invoices: Invoice[]; expenses: Expense[]; payments: Payment[]; supervisorLinked?: boolean };
type ModalKind = "customer" | "person" | "vendor" | "order" | "orderVendor" | "invoice" | "expense" | "payment" | null;

const emptyData: AppData = { customers: [], historyCustomers: [], persons: [], vendors: [], orders: [], historyOrders: [], orderVendors: [], invoices: [], expenses: [], payments: [] };
const navItems = [
