...
export function ensureSchema() {
  ...
  schemaReady = (async () => {
    ...
    await d1.batch([
      ...
      d1.prepare("CREATE TABLE IF NOT EXISTS order_vendors (id text PRIMARY KEY NOT NULL, order_id text NOT NULL, vendor_id text NOT NULL, product_name text NOT NULL, amount integer NOT NULL, notes text DEFAULT '' NOT NULL, created_at text NOT NULL)"),
